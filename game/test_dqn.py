...
while episode < 2000:
    ...
    while not gameover:
        ...
        new_obs_n[0] = new_obs_n[0].reshape(1, new_obs_n[0].shape[0], new_obs_n[0].shape[1], new_obs_n[0].shape[2])
        ...
        DQN_agent.remember(obs_n[0], action1, rew_n[0], new_obs_n[0], terminal)
        if done or terminal:
            gameovers += 1
